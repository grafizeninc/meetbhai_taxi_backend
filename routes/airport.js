...
router.get(
  "/available-airport",
  airportController.getAvailableAirportInDestination
);
router.post(
  "/available-airport",
  airportController.addAvailableAirportInDestination
);
...
router.get(
  "/available-airports",
  airportController.getAvailbleAirportsInDestination
);
...
router.post(
  "/airport-bulk-upload",
  uploadAirportFile,
  airportController.handleAirportUpload
);
router.post(
  "/destination-bulk-upload",
  uploadDestinationFile,
  airportController.handleDestinationUpload
);
router.get("/airport-download", airportController.downloadAirportFile);
router.get("/airport-download/:document", airportController.downloadAirportFileNew);
